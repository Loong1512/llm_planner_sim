...
echo_and_run cd "/home/ros/ur5_sim/src/robotiq/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ros/ur5_sim/src/robotiq/robotiq_modbus_tcp/setup.py" \
     \
    build --build-base "/home/ros/ur5_sim/build/robotiq/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
