...
echo_and_run cd "/home/ros/ur5_sim/src/robotiq/robotiq_2f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ros/ur5_sim/src/robotiq/robotiq_2f_gripper_control/setup.py" \
     \
    build --build-base "/home/ros/ur5_sim/build/robotiq/robotiq_2f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
