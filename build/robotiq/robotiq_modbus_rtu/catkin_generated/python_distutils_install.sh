...
echo_and_run cd "/home/ros/ur5_sim/src/robotiq/robotiq_modbus_rtu"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ros/ur5_sim/src/robotiq/robotiq_modbus_rtu/setup.py" \
     \
    build --build-base "/home/ros/ur5_sim/build/robotiq/robotiq_modbus_rtu" \
    install \
    --root="${DESTDIR-/}" \
